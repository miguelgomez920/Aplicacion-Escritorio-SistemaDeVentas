...
public class InterUsuario extends javax.swing.JInternalFrame {
    ...
    public InterUsuario() {
        ...
        //para el checkbox que me permite ver la contraseña cuando lo selecciono
    ...
    private void jButton_GuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_GuardarActionPerformed
        //con este if se valida que el usuario si haya escrito en todas las cajas de texto obligatorias
        ...
        this.Limpiar();//para limpiar todos los campos o cajas de texto
    ...
    private void jCheckBox_ver_claveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jCheckBox_ver_claveMouseClicked
        if (jCheckBox_ver_clave.isSelected() == true) { //si selecciona el checkbox con el mouse (es decir si esta marcado con un chulo)
            String pass = "";
            char[] passIngresado = txt_password.getPassword();// Obtener la contraseña ingresada como un arreglo de caracteres
            for (int i = 0; i < passIngresado.length; i++) {// Recorrer el arreglo de caracteres para construir la cadena de contraseña
                pass += passIngresado[i];
            }
            txt_password_visible.setText(pass);//establecemos la contraseña en la caja de texto
            txt_password.setVisible(false);//ponemos invisible la caja de texto que esta en la parte de atras
            txt_password_visible.setVisible(true);//ponemos visible la caja de texto que esta encima, donde esta la contraseña visible
            
        } else {//vuelve al estado normal
    ...
    /**
     * Metodo para limpiar campos del JInternalFrame interCliente
     */
